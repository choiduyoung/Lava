 	...
 	제어명령
 		...
 		종류]
 			1. 조건제어명령
 				...
 				형식 2]
 					==> 조건식이 참일경우와 거짓일 경우의 처리 내용을 모두 기술해 놓는 조건문
 					(1)
 					if(조건식-(2)) {
 						실행문 1 -(3) <==참일경우 실행부
 						}else {
 				...
 				형식 3]
 					==> 두가지 이상의 조건식을 주고 각 조건이 맞는 경우 처리내용을 정의해놓는 조건문
 					(1)
 					if(조건식1- (2)) {
 						실행문 1 - (3)
 					}else if (조건식2 -(4)) {
 			...
 			if(조건식1) {
 				...
 				*****
 				...
 				형식]
 					...
 					순서]
 						비교내용와 데이터1이 같을경우 : 1-> 2-> 3 -> 4 > 5 -> 10
 						비교내용와 데이터2이 같을경우 : 1-> 2-> 3 -> 6 > 7 -> 8 -> 10
...
//예제] 숫자 두개를 입력받아서 큰수에서 작은수를 뺀 차를 출력하세요
	...
	public void solv() {
		...
		// 출력하고
		 System.out.println("입력한 두수" + no1 + " & " + no2 + "의 차 입니다" + cha + "입니다" );
	}
