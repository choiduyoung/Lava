...
/*
 	...
 	입력받은 숫자가 1이면 삼각형의 넓이를 
 			   2이면 사각형희 넓이를 구해주는 프로그램을 작성하세요.
 */
	public Test06() {
		// 입력받을 준비하고
		Scanner sc = new Scanner(System.in);
		// 메시지 출력해주고
		System.out.println("삼각형의 넓이는 1, 사각형 넓이는 2 를 입력하세요! : ");
		int code = sc.nextInt();
		...
		//코드값이 1 이면 삼각형 넓이를 구해서 출력해주고 , 2면 사각형 넓이를 구해서 출력해주자
		/*
		  	사각형과 삼각형의 넓이의 타입 다르기 때문에 
		  	한가지 타입으로 통일 시켜줘야겠다.
...
//		[방법1]
		/*
		String result = (code == 1) ? ("삼각형의 넓의 : " + samgak(no1, no2)+"") : 
						(
		...
		*/
		...
		String result = (code == 1 ) ? ("삼각형넓이는 " + semo) : 
									  (
